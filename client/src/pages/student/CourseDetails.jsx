...
const toggleSection = (index) => {
  ...
  return courseData ? (
    ...
    <div className='max w-xl z-10 text-gray-500'>
      ...
      dangerouslySetInnerHTML={{__html: courseData.courseDescription.slice(0,
     200)}}></p>
          ...
          {courseData.courseContent.map((chapter, index) => (
            <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
              ...
              cursor-pointer select-none' onClick={()=> toggleSection(index)}>
                ...
                <img img className={`transform transition-transform ${openSections [index] ? 'rotate-180' : ''}`} 
    ...
    <div className="max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]">
      ...
      <div className='p-5'>
        ...
        md:pt-4 text-gray-500'>
          ...
          <div className='pt-6'>
            <p className='m:text-xl text-lg font-medium text-gray-800'>What's in the course?</p>
