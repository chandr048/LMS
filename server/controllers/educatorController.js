...
export const addCourse = async (req, res) => {
  try {
    ...
    if (
      !parsedCourseData.courseTitle ||
      !parsedCourseData.courseDescription ||
      parsedCourseData.coursePrice === undefined ||
      parsedCourseData.discount === undefined
    ) {
      return res
        .status(400)
        .json({ success: false, message: "Missing required course fields" });
    }

    // Validate lecture data if courses have content
    if (
